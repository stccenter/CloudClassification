...
Copy requirements.txt from cloned repository and place it inside cloudclassify folder. Use the following command to install all necessary packages at once:
...
4. Download cuDNN library
   ...
   4. d.	It will download as a compressed folder. Extract the compressed folder.
...
5. Set up the virtual environment
   ...
   6. f.	Copy and paste below line in command prompt. This activates the virtual environment.
...
#### **Enabling GPU in Windows Desktop**
